...
export function SocialAuthButtons({ mode = 'signin', callbackUrl = '/dashboard' }: SocialAuthButtonsProps) {
    ...
    <div className="space-y-3">
      <div className="relative">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-2 bg-white text-gray-500">Or {actionText.toLowerCase()} with</span>
        </div>
      </div>
